...
const ButtonBlock = ({ block, onSelect, isPreview }) => {
    ...
    const dynamicInlineStyle = {
        ...
        cursor: isPreview && props.href && props.href !== "#" ? "pointer" : "default",
    };
    ...
    if (props.hoverEffect) {
        dynamicInlineStyle.transition = "background-color 0.3s ease, color 0.3s ease";
        if (isHovered) {
            dynamicInlineStyle.backgroundColor = props.hoverBackgroundColor || "#0056b3";
    ...
    if (Tag === "a") {
        ...
        tagSpecificProps.rel = props.target === "_blank" ? "noopener noreferrer" : undefined;
    } else {

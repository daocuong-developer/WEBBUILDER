...
//             // ✅ Đảm bảo children được lấy đúng thứ tự theo childrenIds
//             const childBlocks = childrenIds.map((id) => canvasElements.find((el) => el.id === id)).filter(Boolean); // loại bỏ null nếu có
...
//             className="w-64 bg-white border-r border-gray-200 flex flex-col h-[90vh] overflow-hidden"
//         >
//             {/* Nút thu gọn/mở rộng */}
//             <button
//                 onClick={() => setIsCollapsed(!isCollapsed)}
//                 className="absolute -right-3 top-4 bg-white border rounded-full shadow p-1 z-10"
//             >

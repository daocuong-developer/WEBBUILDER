...
export default function RenderBlockComponent({ block, blocks, onSelect, onChange, isPreview = false }) {
    ...
    switch (block.type) {
        ...
        default:
            ...
            return (
                <div className="p-4 bg-red-100 text-red-700 border border-red-400 rounded-md" onClick={handleSelect}>
